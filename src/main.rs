...
const ATOM_MATRIX_SIZE: usize = 3;
const MATRIX_SIZE: usize = ATOM_MATRIX_SIZE * ATOM_MATRIX_SIZE;
...
fn solve(round: u32, matrix: [[u8; MATRIX_SIZE]; MATRIX_SIZE], pos: u8) -> bool {
...
fn main() {
    ...
    let now = Instant::now();
    solve(0, source_matrix4.clone(), 0);
